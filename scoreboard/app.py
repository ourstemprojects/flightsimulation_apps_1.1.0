...
08.09.17    J. Berendt      1.4.2       Replaced default UI banner.
                                        Updated default company logo to white.
                                        BUG01: The table headings for the scoreboard are wrong.
                                        FIX01: Updated range from which Jinga uses to get column
                                        headings.
------------------------------------------------------------------------------------------------'''
